...
--
-- Host: localhost
-- Generation Time: Nov 07, 2019 at 02:33 AM
...
-- Database: `ICS370`
--
CREATE DATABASE IF NOT EXISTS `ICS370` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ICS370`;
...
(1, 'test', 'test123', '2019-10-27 10:27:02');
...
--
-- AUTO_INCREMENT for table `vegan`
--
ALTER TABLE `vegan`
  MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `customer`
  ADD CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`id`) REFERENCES `login` (`id`);

--
-- Constraints for table `cust_orders`
--
ALTER TABLE `cust_orders`
  ADD CONSTRAINT `cust_orders_ibfk_1` FOREIGN KEY (`cust_id`) REFERENCES `customer` (`cust_id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"ICS370\",\"table\":\"login\"},{\"db\":\"ICS370\",\"table\":\"cust_orders\"},{\"db\":\"ICS370\",\"table\":\"customer\"},{\"db\":\"ICS370\",\"table\":\"junk\"},{\"db\":\"ICS370\",\"table\":\"vegan\"},{\"db\":\"ICS370\",\"table\":\"healthy\"}]');
...
('ICS370', 'cust_orders', 'cust_id', 'ICS370', 'customer', 'cust_id');
...
('root', '2019-11-07 01:32:54', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
